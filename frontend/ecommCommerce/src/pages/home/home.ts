...
export class HomePage implements OnInit {
 ...
 // servicesAvail = [];
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private alertCtrl: AlertController,
   ...
   /* dragulaService.createGroup('SERVICE1', {
      copy: (el, source) => {
 ...
 //   this.customerId = $event
  ...
  ngOnInit() {
    ...
    this.globalService.getLoggedProffessionalData();
  ...
  ionViewWillEnter() {
    this.loggedUser = this.globalService.getLoggedProffessionalData();
    /*Çif (this.loggedUser.userId === '' || this.loggedUser.userId == null) {
...
/*
  updateEvent(event) {
    let modal = this.modalCtrl.create('EventModalPage2', {selectedDay: event.startTime, eventSelected: event, customerSelected: event.customerId, professional: this.loggedUser});
    modal.present();
